...
main(int argc, char **argv)
{
    ...
    for (i = 1; i < argc; i++) {
        if (strcmp(argv[i], "-d") == 0) {
	       ...
	       i++;
            ...
            ASSERT(i + 1 < argc);   // next argument is scheduler string
            schedulerArg = argv[i + 1];
            i++;
       }
    ...
    if(strcmp(schedulerArg, "FCFS") == 0) {
        type = FCFS;
    } else if (strcmp(schedulerArg, "SJF") == 0) {
        type = SJF;
    } else if (strcmp(schedulerArg, "PRIORITY") == 0) {
        type = Priority;
    } else if (strcmp(schedulerArg, "RR") == 0) {
        type = RR;
    }
//
